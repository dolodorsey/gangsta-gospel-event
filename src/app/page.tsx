...
// ─── TOKENS ──────────────────────────────────────────────────────────────────
const accent = "#c87a5a";
const accentDeep = "#7a3a2a";
const glow = "rgba(200,122,90,0.15)";
const serif = "'Cormorant Garamond','Playfair Display',Georgia,serif";
const sans = "'DM Sans','Inter',system-ui,sans-serif";
const bg = "#070508";
const surface = "#0a0608";
const cream = "#f0ece4";
  ...
  return (
    <nav style={{
      ...
      <div>
        ...
        <div style={{ fontFamily: serif, fontSize: 22, fontWeight: 600, color: cream, letterSpacing: "0.04em" }}>Gangsta Gospel</div>
      </div>
    ...
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1400, margin: "0 auto", width: "100%" }}>
        <div style={{
          ...
          {"Faith Meets Culture"} &nbsp;·&nbsp; {"Select Cities · 2026"}
        </div>
        <h1 style={{
          ...
          The Room That Understands Both Sides
        </h1>
        <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "clamp(40px,6vw,96px)", alignItems: "start" }}>
          ...
          <div>
            <p style={{ fontFamily: serif, fontSize: "clamp(22px,2.5vw,34px)", fontWeight: 400, lineHeight: 1.4, letterSpacing: "-0.02em", color: cream, fontStyle: "italic" }}>
              An experience built for people who move between worlds. Gangsta Gospel holds space where faith, culture, street credibility, and spiritual conviction exist without contradiction.
            </p>
            <p style={{ marginTop: 24, fontFamily: sans, fontSize: 14, lineHeight: 1.9, color: muted }}>
              Gangsta Gospel is a production of The Kollective Hospitality Group — built to operate across major cities with consistency, identity, and cultural authority. Each city drop is intentional.
            </p>
          </div>
        </div>
      </Reveal>
    ...
    <section style={{ padding: "0 clamp(32px,6vw,96px) clamp(80px,10vw,140px)", maxWidth: 1400, margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 1, background: border }}>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: serif, fontSize: 16, fontWeight: 700, color: cream, letterSpacing: "-0.02em", marginBottom: 10 }}>Dual World Programming</div>
          <div style={{ fontSize: 13, lineHeight: 1.7, color: muted }}>Music, speakers, and energy that speak to both sides of the experience. No compromises. No contradictions.</div>
        </div>
        <div style={{
          background: "rgba(255,255,255,0.03)",
          border: "1px solid rgba(255,255,255,0.07)",
          ...
          <div style={{ fontFamily: serif, fontSize: 16, fontWeight: 700, color: cream, letterSpacing: "-0.02em", marginBottom: 10 }}>Live Worship Energy</div>
          <div style={{ fontSize: 13, lineHeight: 1.7, color: muted }}>Worship moments that hit with the same energy as a headline set. Spirit-forward, crowd-responsive.</div>
        </div>
        <div style={{
          background: "rgba(255,255,255,0.03)",
          border: "1px solid rgba(255,255,255,0.07)",
          ...
          <div style={{ fontFamily: serif, fontSize: 16, fontWeight: 700, color: cream, letterSpacing: "-0.02em", marginBottom: 10 }}>Culture Credibility</div>
          <div style={{ fontSize: 13, lineHeight: 1.7, color: muted }}>Gangsta Gospel doesn't sanitize. It honors the whole identity of people who move between faith and street.</div>
        </div>
        <div style={{
          background: "rgba(255,255,255,0.03)",
          border: "1px solid rgba(255,255,255,0.07)",
          ...
          <div style={{ fontFamily: serif, fontSize: 16, fontWeight: 700, color: cream, letterSpacing: "-0.02em", marginBottom: 10 }}>Community Platform</div>
          <div style={{ fontSize: 13, lineHeight: 1.7, color: muted }}>Pastors, community leaders, artists, and activists share the same room. The connections formed here matter.</div>
        </div>
        <div style={{
          background: "rgba(255,255,255,0.03)",
          border: "1px solid rgba(255,255,255,0.07)",
          ...
          <div style={{ fontFamily: serif, fontSize: 16, fontWeight: 700, color: cream, letterSpacing: "-0.02em", marginBottom: 10 }}>Production Excellence</div>
          <div style={{ fontSize: 13, lineHeight: 1.7, color: muted }}>Full KHG production: lighting, sound, hospitality. Gangsta Gospel is fully produced, not a church event.</div>
        </div>
        <div style={{
          background: "rgba(255,255,255,0.03)",
          border: "1px solid rgba(255,255,255,0.07)",
          ...
          <div style={{ fontFamily: serif, fontSize: 16, fontWeight: 700, color: cream, letterSpacing: "-0.02em", marginBottom: 10 }}>Non-Profit Integration</div>
          <div style={{ fontSize: 13, lineHeight: 1.7, color: muted }}>Playmakers Sports Association and KHG's community programs connect directly through Gangsta Gospel.</div>
        </div>
      </div>
    </section>
  );
    ...
    <section style={{ padding: "clamp(80px,10vw,140px) clamp(32px,6vw,96px)" }}>
      <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(40px,6vw,80px)", alignItems: "start" }}>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: serif, fontSize: "clamp(20px,2.5vw,32px)", fontWeight: 600, color: cream, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 16 }}>The Recognition Moment</div>
          <div style={{ fontSize: 14, lineHeight: 1.8, color: muted }}>Someone in the room realizes they aren't alone in how they hold both worlds. That moment is everything.</div>
        </div>
        <div style={{
          position: "relative",
          padding: "40px 32px",
          ...
          <div style={{ fontFamily: serif, fontSize: "clamp(20px,2.5vw,32px)", fontWeight: 600, color: cream, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 16 }}>The Worship Break</div>
          <div style={{ fontSize: 14, lineHeight: 1.8, color: muted }}>The room goes quiet, then lifts. Gangsta Gospel creates worship moments that feel earned, not forced.</div>
        </div>
        <div style={{
          position: "relative",
          padding: "40px 32px",
          ...
          <div style={{ fontFamily: serif, fontSize: "clamp(20px,2.5vw,32px)", fontWeight: 600, color: cream, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 16 }}>The Speaker Pivot</div>
          <div style={{ fontSize: 14, lineHeight: 1.8, color: muted }}>A word that lands in both registers simultaneously. The crowd responds in full.</div>
        </div>
        <div style={{
          position: "relative",
          padding: "40px 32px",
          ...
          <div style={{ fontFamily: serif, fontSize: "clamp(20px,2.5vw,32px)", fontWeight: 600, color: cream, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 16 }}>The Altar Call Energy</div>
          <div style={{ fontSize: 14, lineHeight: 1.8, color: muted }}>Not traditional. Not secular. Somewhere in between — and fully intentional.</div>
        </div>
        </div>
      </div>
    </section>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <Reveal delay={0.2}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 0, marginBottom: 48 }}>
            <span key="Atlanta" style={{ display:"inline-block", padding:"8px 20px", border:`1px solid ${accent}28`, color: accent, fontSize: 11, letterSpacing: "0.28em", textTransform: "uppercase", marginRight: 8, marginBottom: 8 }}>Atlanta</span> <span key="Houston" style={{ display:"inline-block", padding:"8px 20px", border:`1px solid ${accent}28`, color: accent, fontSize: 11, letterSpacing: "0.28em", textTransform: "uppercase", marginRight: 8, marginBottom: 8 }}>Houston</span> <span key="Washington DC" style={{ display:"inline-block", padding:"8px 20px", border:`1px solid ${accent}28`, color: accent, fontSize: 11, letterSpacing: "0.28em", textTransform: "uppercase", marginRight: 8, marginBottom: 8 }}>Washington DC</span> <span key="Charlotte" style={{ display:"inline-block", padding:"8px 20px", border:`1px solid ${accent}28`, color: accent, fontSize: 11, letterSpacing: "0.28em", textTransform: "uppercase", marginRight: 8, marginBottom: 8 }}>Charlotte</span>
          </div>
        </Reveal>
        <Reveal delay={0.4}>
...
function Footer() {
  return (
      ...
      <div>
        <div style={{ fontFamily: serif, fontSize: 18, fontWeight: 600, color: accent, letterSpacing: "0.06em" }}>Gangsta Gospel</div>
  ...
  return (
    <section id="tickets" style={{
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"10px"}}>
            ...
            <a href="https://www.eventbrite.com/e/gangsta-gospel-tickets-1983357015223" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
            ...
            <a href="https://www.eventbrite.com/e/gangsta-gospel-tickets-1983357554837" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
            ...
            <a href="https://www.eventbrite.com/e/gangsta-gospel-tickets-1983358448510" target="_blank" rel="noopener noreferrer" style={{
              display:"flex", justifyContent:"space-between", alignItems:"center",
              padding:"16px 20px", borderRadius:"14px",
              background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.08)",
              textDecoration:"none", color:"inherit",
